...
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id, registration_date)
VALUES (1, 'John', 'Doe', '555-3211', 'johndoe@patient.com', 'P001', '1991-01-01', 2, '2024-01-01'),
       (2, 'Hiroshi', 'Tanaka', '555-3212', 'hiroshitanaka@patient.com', 'P002', '1992-01-01', 4, '2024-01-02'),
       (3, 'Emily', 'Smith', '555-3213', 'emilysmith@patient.com', 'P003', '1993-01-01', 6, '2024-01-03'),
       (4, 'Oliver', 'Jones', '555-3214', 'oliverjones@patient.com', 'P004', '1994-01-01', 8, '2024-01-04'),
       (5, 'Sophie', 'Müller', '555-3215', 'sophiemüller@patient.com', 'P005', '1995-01-01', 10, '2024-01-05');
